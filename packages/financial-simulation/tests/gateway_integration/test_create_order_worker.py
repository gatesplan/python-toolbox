"""CreateOrderWorker TDD 테스트 (financial-simulation 통합)

TDD Phase 1: Red - 테스트 작성
"""
...
# ========== Request/Response 구조 (임시 정의) ==========
# 실제로는 financial-gateway에서 import되어야 함
...
# ========== Worker 구현 (TDD Phase 2) ==========

class CreateOrderWorker:
    """주문 생성 Worker (Simulation)"""

    def __init__(self, exchange: SpotExchange):
